...
####From the above results we can see that an accuracy of 99.39% is obtained with the out of sample error of 0.61%. With this amount of accuracy it is safe to say that we can progress towards the final prediction
...
modFit_pred_test <- predict(modFit, pml_testing_mod)
